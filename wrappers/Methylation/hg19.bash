...
refmain="/project/6007495/singularity/1.1.0/builtin/genomes/${specie}/${build}"
...
bismark_methylation_extractor --CX --no_overlap --gzip --bedGraph --no_header --comprehensive --multicore 8 --cytosine_report --ignore 3 --ignore_r2 3 --ignore_3prime 3 --ignore_3prime_r2 3 --buffer_size 60G --genome_folder ${refbismark} ${sample}_bismark_bt2_pe.bam
