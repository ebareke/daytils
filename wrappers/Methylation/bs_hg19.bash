#!/bin/bash
#
# equivalent to bswalker -- current release
#
# set -e
# set -x
# set -o pipefail
...
#
refmain="/project/6007495/singularity/1.1.0/builtin/genomes/Hsapiens/${build}"
...
####################################################################################################
#unset DISPLAY
#qualimap  bamqc -nt 8 -bam ${sample}_bismark_bt2_pe.coordsrt.bam -gd HUMAN -outdir ${outdir} -outformat HTML --java-mem-size=40G
